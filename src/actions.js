...
const attackBoom = (scene) => {
  if (Phaser.Input.Keyboard.JustDown(scene.space)) {
    const beam = scene.physics.add.sprite(scene.player.x, scene.player.y, 'boom');
...
export {
  addEnemies, addTanks, addRocks, moveTank, moveEnemies,
  watchKeyboard, attackBoom, colliders, levelUp,
};